...
\item Input: nucleotide alphabet $\Omega$
\item Output: real numbers signifying current levels $\Re$
...
\hline
Start & Start & $p^{\paramlabel{StartEmit}}$ & & $y_s \sim \paramlabel{Normal}(\mu^{\paramlabel{Start}},\tau^{\paramlabel{Start}})$ \\
Start & Start & $1$ & $x \in \Omega$ & \\
Start & Match${}_{x_1 \ldots x_N}$ & $1 - p^{\paramlabel{StartEmit}}$ & $x_1 \ldots x_N \in \Omega^N$ & \\
Match${}_{x_1 \ldots x_N}$ & Match${}_{x_1 \ldots x_N}$ & ${p^{\paramlabel{MatchEmit}}_{x_1\ldots x_N}}$ & & $y_m \sim \paramlabel{Normal}(\mu^{\paramlabel{Match}}_{x_1\ldots x_N},\tau^{\paramlabel{Match}}_{x_1\ldots x_N})$ \\
