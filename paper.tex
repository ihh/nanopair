...
\item Probability is
\[
P(y_1 \ldots y_K) dy_1 \ldots dy_K = \left( 1 - p^{\paramlabel{NullEvent}} \right)
 \prod_{n=1}^K p^{\paramlabel{NullEvent}} P(y_n|\mu^{\paramlabel{Null}},\tau^{\paramlabel{Null}}) dy_n
\]
\end{itemize}
