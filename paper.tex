...
\item Parameters:
$p^{\paramlabel{StartEmit}}, p^{\paramlabel{Skip}}, p^{\paramlabel{BeginDelete}}, p^{\paramlabel{ExtendDelete}},$ \\
...
Match${}_{x_1 \ldots x_N}$ & Match${}_{x_2 \ldots x_{N+1}}$ & $(1 - {p^{\paramlabel{MatchEmit}}_{x_1\ldots x_N}})$ & $x_{N+1} \in \Omega$ & $y_m \sim \mbox{Normal}(\mu^{\paramlabel{Match}}_{x_1\ldots x_N},\tau^{\paramlabel{Match}}_{x_1\ldots x_N})$ \\
& & $\times (1 - p^{\paramlabel{BeginDelete}}) (1 - p^{\paramlabel{Skip}})$ & & \\
& & $\times P(y_m|\mu^{\paramlabel{Match}}_{x_1\ldots x_N},\tau^{\paramlabel{Match}}_{x_1\ldots x_N}) dy_m$ & & \\
